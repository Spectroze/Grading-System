 ...
 * @author Kenneth
 */
public class add3rdGrades extends javax.swing.JDialog {

   Connection con;
    
    public add3rdGrades(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
   Connect();
    }
    ...
    public void Connect(){
         try {
           ...
           Logger.getLogger(add3rdGrades.class.getName()).log(Level.SEVERE, null, ex);
       }
    }
    /**
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(NET101, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 210, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(add3rdGrades.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                add3rdGrades dialog = new add3rdGrades(new javax.swing.JFrame(), true);
